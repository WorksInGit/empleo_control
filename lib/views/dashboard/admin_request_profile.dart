...
class AdminRequestProfile extends StatelessWidget {
  const AdminRequestProfile({super.key});
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
                  ...
                  Column(
                    children: [
                      IconButton(
                        onPressed: () {},
                        icon: Icon(
                        Iconsax.shield_tick5, size: 60, color: Colors.black,),),
                  ...
                  Column(
                    children: [
                      IconButton(
                       ...
                       Text('CALL', style: GoogleFonts.poppins(fontWeight: FontWeight.bold))
                    ],
                  ),
                  Padding(
            ...
            Padding(
              padding: EdgeInsets.only(top: 705, left: 310),
              child: Text('DENY', style: GoogleFonts.poppins(fontWeight: FontWeight.bold),),
            )
          ],
        ),
      ),
